...
const config = {
    ...
    colors: ['rgb(3, 240, 240)', 'rgb(113, 254, 145)', 'rgb(254, 254, 245)', 'rgb(255, 207, 96)'],
    sizes: ['1.5rem', '0.7rem', '1.3rem']
...
function createStar(position) {
    ...
    star.setAttribute('fill', config.colors[selectRandom(config.colors)]);
    ...
    star.style.height = config.sizes[selectRandom(config.sizes)];
